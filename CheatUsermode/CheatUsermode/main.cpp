...
int main()
{
	HANDLE hDriver = CreateFile(L"\\\\.\\cheatDevice", GENERIC_READ | GENERIC_WRITE, 0, NULL, OPEN_EXISTING, 0, NULL);
	...
	if (hDriver != INVALID_HANDLE_VALUE)
	{
		...
		MessageBoxA(NULL, reinterpret_cast<LPCSTR>(buffer), "Cheat report", MB_OK);
